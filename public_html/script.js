window.addEventListener('load',function(){
    ...
    class Fire{
        constructor(game, x, y){
            ...
            this.frameX = 0;//Math.floor(Math.random() * 3);
            this.frameY = 0;//Math.floor(Math.random() * 3);
            this.markedForDeletion = false;
            this.maxFrame = 8;
            this.width = 200;
            this.height = 200;
    ...
    class Game{
        ...
        update(deltaTime){
            ...
            this.fires = this.fires.filter(fire => !fire.markedForDeletion);
            ...
            this.enemies.forEach(enemy => {
                ...
                this.player.projectiles.forEach(projectile => {
                    if(this.checkCollisions(projectile, enemy)){
                        ...
                        this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5,
                            enemy.y + enemy.height * 0.5));
                        //this.fires.push(new Fire(this, enemy.x + enemy.width * 0.5,
                        //        enemy.y + enemy.height * 0.5));
                        if(enemy.lives <= 0){
                            for(let i = 0; i < 5; i++){
                                this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5,
                                     enemy.y + enemy.height * 0.5));
                                this.fires.push(new Fire(this, enemy.x,
                                     enemy.y));
                                this.smokes.push(new Smoke(this, enemy.x,
                                     enemy.y));
                            }
                            enemy.markedForDeletion = true;
        ...
        draw(context){
            ...
            this.fires.forEach(fire => fire.draw(context));
            this.smokes.forEach(smoke => smoke.draw(context));
            this.enemies.forEach(enemy =>{
                enemy.draw(context);
            });
