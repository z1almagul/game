window.addEventListener('load',function(){
    ...
    class InputHandler{
        constructor(game){
            ...
            window.addEventListener("touchcancel", e=>{this.game.keys.splice(this.game.keys.indexOf(e.key), 1);this.game.player.speedY=this.game.player.maxSpeed;});
        }
    }
    ...
    class Shark extends Enemy{
        constructor(game){
            ...
            this.height = 109;
            this.y = Math.random() * (this.game.height * 0.9 - this.height);
            this.image = document.getElementById('shark');
            this.frameY = 0;
            this.lives = 2;
            this.score = this.lives;
        }
    ...
    class octopus extends Enemy{
        constructor(game){
            ...
            this.height = 105;
            this.y = Math.random() * (this.game.height * 0.9 - this.height);
            this.image = document.getElementById('octopus');
            this.frameY = 0;
            this.lives = 2;
            this.score = this.lives;
        }
    ...
    class UI{
        ...
        draw(context){
            ...
            if(this.game.gameWon){
                ...
                let message1 = 'You won!', message2 = 'You found the treasure!';
        ...
        update(deltaTime){
            ...
            this.enemies.forEach(enemy => {
                ...
                if(this.checkCollisions(this.player, enemy))
                    if(enemy.type === 'treasure') this.player.enterPowerUp();
        ...
        addEnemy(){
            ...
            if(randomize < 0.3)
                this.enemies.push(new Jellyfish(this));
                    ...
                    this.enemies.push(new octopus(this));
            else this.enemies.push(new Treasure(this)) 
        }
